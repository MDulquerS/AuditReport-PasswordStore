...
Md Sumon is a highly skilled freelance blockchain developer on Upwork with a proven track record of success. Having collaborated with over 30 clients on more than 80 projects, he brings extensive expertise in blockchain technologies, smart contracts, and decentralized application development. Md is known for delivering high-quality solutions tailored to client needs and maintaining strong client relationships through professionalism and technical excellence.

# Disclaimer

Md Sumon makes all effort to find as many vulnerabilities in the code in the given time period, but holds no responsibilities for the the findings provided in this document. A security audit by the team is not an endorsement of the underlying business or product. The audit was time-boxed and the review of the code was solely on the security aspects of the solidity implementation of the contracts.
